...
<div   class="container" style="margin-top: 100px;margin-bottom: 100px">
	...
	<h1 style="font-size: 100px;color: #f00f0f"><span class="glyphicon glyphicon-ban-circle"></span></h1>
	<br>
         <h1> Votre Compte est Bloque !</h1>
         
         
         <br>
         <a href="ControleBiblio?appelerPour=demanderReAdhesion&NoCarte=<%=NoCarte%>" class="btn btn-info  <%=(GB.isAdherantDemanderReAdhesion(NoCarte))?" disabled ":"" %>">
			 <h3>Demander Readhesion</h3>
