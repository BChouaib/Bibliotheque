...
<%
	...
	ArrayList<Emprunt> empruntListe=GB.getListeAdherantEmprunt(adherant.getNoCarte());
...
<div class="jumbotron" >
  <div class="container text-left"  >
    <h1><span class="glyphicon glyphicon-inbox"></span> Mes Pretes</h1>      
  </div>
</div>
  ...
  <table class="table table-hover">
    ...
    <%
    	for(int i=empruntListe.size()-1;i>=0;i--){
			...
			if(empruntListe.get(i).getDateRemis()==null)
