...
<div class="container">
  <form class="form-horizontal" role="form" method="post" action="ControleBiblio" id="supprimerDocumentET2Form" >
          <input type="hidden" name="appelerPour" value="supprimerDocumentET2">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">          
        <textarea class="form-control" name="description" id="description"   placeholder="Enter la description du document" maxlength="255" cols="40" rows="5" ><%=document.getDescription() %></textarea>
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-4" for="srcImage">L'image du document:</label>
      <div class="col-sm-5">
      <img alt="" src=""<%=document.getSrcImage() %>">
      </div>
    </div>
	 <div class="form-group">
      <label class="control-label col-sm-4" for="nmbrExemplaire">Nmbr d'Exemplaire :</label>
      <div class="col-sm-5">
        <h4><%=document.getNmbrExemplaire() %></h4>
      </div>
    </div>
    <div class="form-group">        
      <div class="col-sm-offset-4 col-sm-8">
		<button type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-trash"></span> Confirmer la suppression</button>
      </div>
    </div>
  </form>
</div>
