...
<div class="container">
  <form class="form-horizontal" role="form" method="post" action="ControleBiblio" id="modifierDocumentForm" >
          <input type="hidden" name="appelerPour" value="modifierDocument">
    ...
    <div class="form-group">        
	  ...
	  <button type="submit" id="submitBtn" class="btn btn-success" disabled><span class="glyphicon glyphicon-edit"></span> Modifier </button>
      </div>
    </div>
  </form>
</div>
