...
<%
	...
	ArrayList<Reservation> reservationsListe=GB.getListeAdherantReservation(adherant.getNoCarte());
...
<div class="jumbotron" >
  <div class="container text-left"  >
    <h1><span class="glyphicon glyphicon-open-file"></span> Preter Document  </h1>             
  </div>
</div>
...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <%
    	for(int i=0;i<reservationsListe.size();i++){
			exemplaire=GB.getExemplaire(reservationsListe.get(i).getIdExemplaire());
			document=GB.getDocument(exemplaire.getCoteDocument());
    			...
    			out.print("<tr>");
    				...
    				out.print("<td>"+reservationsListe.get(i).getDateReservation()+"</td>");
    			
    				out.print("<td><button type=\"button\" class=\"btn btn-success bntPreter\" value=\""+
    					reservationsListe.get(i).getIdReservation()+"\">Preter</button></td>");
...
$(document).ready(function(){
	...
	$( ".bntPreter").click(function() {
		  var prete=$(this);
		  $.ajax({  
	            type: "GET",  
	            url: "ControleBiblio",  
	            data: "appelerPour=preterDocumentET2&IdReservation="+prete.val() , 
	            async:false,
	            success: function(msg){  
	            	prete.parent().parent().hide(500);
