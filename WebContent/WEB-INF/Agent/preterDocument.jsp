...
<div class="container">
  <form class="form-horizontal" role="form" method="post" action="ControleBiblio" id="preterDocumentForm" >
          <input type="hidden" name="appelerPour" value="preterDocument">
    ...
    <div class="form-group">        
	  ...
	  <button type="submit" id="submitBtn" class="btn btn-success"><span class="glyphicon glyphicon-copy"></span> Obtenez les réservations </button>
      </div> 
    </div>
  </form>
</div>
